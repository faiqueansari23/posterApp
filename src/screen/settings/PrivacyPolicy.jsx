        ...
        <View style={styles.container}>
            ...
            <View style={{ width: '100%', paddingHorizontal: scale(16), height: 70, backgroundColor: '#E1306C', flexDirection: 'row', alignItems: 'center' }}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <Text style={{ color: COLORS.WHITE, fontSize: moderateScale(18), fontWeight: '700', marginLeft: scale(5) }}>Privacy Policy</Text>
                </View>
            </View>
            <View style={styles.subContainer}>
                <WebView
                    source={{ uri: 'https://ashhari.com/pages/Privacy.html' }} // Boss se mila Privacy.html ka URL yahan daal
                    style={styles.webview}
                    onLoadStart={() => console.log('Loading Privacy Policy...')}
                    onLoadEnd={() => console.log('Privacy Policy loaded!')}
