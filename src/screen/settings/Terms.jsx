        ...
        <View style={styles.container}>
            ...
            <View style={{ width: '100%', paddingHorizontal: scale(16), height: 70, backgroundColor: '#E1306C', flexDirection: 'row', alignItems: 'center' }}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <Text style={{ color: COLORS.WHITE, fontSize: moderateScale(18), fontWeight: '700', marginLeft: scale(5) }}>Terms and Conditions</Text>
                </View>
            </View>
            <View style={styles.subContainer}>
                <WebView
                    source={{ uri: 'https://ashhari.com/pages/terms.html' }} // Boss se mila Terms.html ka URL yahan daal
                    style={styles.webview}
                    onLoadStart={() => console.log('Loading Terms and Conditions...')}
                    onLoadEnd={() => console.log('Terms and Conditions loaded!')}
